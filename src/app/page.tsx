...
import { MantleCapitalFlowMap } from '@/src/components/MantleCapitalFlowMap';
          ...
          {activeTab === 'grid' ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="bento-card flex flex-col justify-between min-h-[340px] relative hover:-translate-y-0.5" id="card-mantle-health-score">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="text-[10px] font-mono bg-[#10B981]/10 text-[#10B981] px-2.5 py-1 rounded-full font-bold uppercase tracking-wider">
                      Active
                    </span>
                  </div>
            ...
            >
              ...
              <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {/* Stat 3 */}
                <div className="bento-card hover:border-amber-500/10 transition-all duration-300 flex flex-col justify-between p-5">
                  <div className="flex justify-between items-start mb-2">
                  ...
                  <p className="text-[10px] text-[var(--text-secondary)] font-medium mt-3 flex items-center gap-1">
                    Trending capital momentum
                  </p>
                </div>

                {/* Stat 4 */}
                <div className="bento-card hover:border-blue-500/10 transition-all duration-300 flex flex-col justify-between p-5">
                  <div className="flex justify-between items-start mb-2">
